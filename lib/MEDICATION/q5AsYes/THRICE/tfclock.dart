...
import 'package:medion/MEDICATION/q5AsYes/THRICE/tSclock.dart';
import 'package:medion/MEDICATION/q5AsYes/THRICE/tfirst.dart';

class TFCLOCK extends StatefulWidget {
  @override
  _TFCLOCKState createState() => _TFCLOCKState();
}

class _TFCLOCKState extends State<TFCLOCK> {
   TimeOfDay time;
  @override
  void initState() {
    super.initState();
