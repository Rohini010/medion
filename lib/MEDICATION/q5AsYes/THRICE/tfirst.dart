...
class TFIRST extends StatefulWidget {
  @override
  _TFIRSTState createState() => _TFIRSTState();
}

class _TFIRSTState extends State<TFIRST> {
                        ...
                        children: [
                          ...
                          Row(
                            children: [    IconButton(
                                                ...
                                                size: 36.0, color: Colors.white),onPressed: () {Navigator.push(context,
                                        MaterialPageRoute(builder: (context) {
                                      return YES();
                                    }));
