...
//import 'package:medion/MEDICATION/q5AsYes/THRICE/tfclock.dart';
class F1CLOCK extends StatefulWidget {
  @override
  _F1CLOCKState createState() => _F1CLOCKState();
}

class _F1CLOCKState extends State<F1CLOCK> {
  TimeOfDay time;
  @override
  void initState() {
    super.initState();
