...
import 'package:medion/MEDICATION/q5AsYes/TWICE/SENdd.dart';
            ...
            children: <Widget>[
              SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Row(
                            children: [Icon(Icons.calendar_today),SizedBox(width: 15,),
                  ...
                  child: ListTile(
                    title: Text(
                        " ${pickedDate.day},${pickedDate.month.toString()}${pickedDate.year.toString()}",style: TextStyle(
                                            fontSize: 23.0,
                                            fontWeight: FontWeight.normal,
                                            color: Colors.black),),
                    onTap: _pickDate,
